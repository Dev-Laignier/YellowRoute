...
import { Center, Icon, ScrollView, IconButton, Avatar, HStack, VStack, Box } from "native-base";
...
const ClientRegister = () => {
  ...
  return (
    <VStack pl={"1%"} pr={"1%"} bg={"#F6C101"} flex={1} justifyContent={"space-between"} alignItems={"center"}>
      <Header />
        ...
        <Center>
          ...
          <>
            ...
            >
              ...
              <TouchableOpacity
                onPress={() => setShowPersonals(!showPersonals)}
              >
                <Icon
                  as={
                    <AntDesign
